    ...
    >
      ...
      <div className="relative z-10">
        <div className="text-center mb-6 space-y-2">
          <h2 style={{ fontFamily: "'Urbanist', sans-serif" }} className={`font-bold tracking-tight leading-[1] text-xl min-[320px]:text-2xl md:text-3xl ${isDark ? 'text-white' : 'text-slate-900'}`}>Welcome back</h2>
